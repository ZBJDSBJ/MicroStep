...
public class PedometerCardEntityDao extends AbstractDao<PedometerCardEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property StepCounterValue = new Property(8, Float.class, "stepCounterValue", false, "STEP_COUNTER_VALUE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PedometerCard\" (" + //
                ...
                "\"STEP_COUNTER_VALUE\" REAL);"); // 8: stepCounterValue
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PedometerCard\"";
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, PedometerCardEntity entity) {
        ...
        Float stepCounterValue = entity.getStepCounterValue();
        if (stepCounterValue != null) {
            stmt.bindDouble(9, stepCounterValue);
        }
    }
    ...
    public PedometerCardEntity readEntity(Cursor cursor, int offset) {
        PedometerCardEntity entity = new PedometerCardEntity( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getFloat(offset + 8) // stepCounterValue
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PedometerCardEntity entity, int offset) {
        ...
        entity.setStepCounterValue(cursor.isNull(offset + 8) ? null : cursor.getFloat(offset + 8));
     }
